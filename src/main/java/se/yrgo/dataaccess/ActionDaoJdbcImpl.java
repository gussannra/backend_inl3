...
public class ActionDaoJdbcImpl implements ActionDao {
    ...
    public void create(Action newAction) {
        jdbcTemplate.update(INSERT_SQL, newAction.getDetails(), newAction.isComplete(), newAction.getOwningUser(), newAction.getRequiredBy());
    }

    private void createTables() {
        try {
            this.jdbcTemplate.update("CREATE TABLE ACTION (ACTION_ID integer generated by default as identity (start with 1), DETAILS VARCHAR(255), COMPLETE BOOLEAN, OWNING_USER VARCHAR(20), REQUIRED_BY DATE)");
    ...
    public List<Action> getIncompleteActions(String userId) {
        return this.jdbcTemplate.query(GET_INCOMPLETE_SQL, new ActionRowMapper(), userId, false);
    }

    public void update(Action actionToUpdate) throws RecordNotFoundException {
        this.jdbcTemplate.update(UPDATE_SQL, actionToUpdate.getDetails(), actionToUpdate.isComplete(), actionToUpdate.getOwningUser(), actionToUpdate.getRequiredBy().getTime(), actionToUpdate.getActionId());
    }

    public void delete(Action oldAction) throws RecordNotFoundException {
        this.jdbcTemplate.update(DELETE_SQL, oldAction.getActionId());
    }
